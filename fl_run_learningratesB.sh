...
server_sgdmlr0p5_args="-d 69 -e 1 --serveropt sgd --lr 0.5 --wdecay 0 --momentum 0.9"
server_sgdmlr0p75_args="-d 69 -e 1 --serveropt sgd --lr 0.75 --wdecay 0 --momentum 0.9"
server_sgdmlr1p0_args="-d 69 -e 1 --serveropt sgd --lr 1.0 --wdecay 0 --momentum 0.9"
server_sgdmlr1p25_args="-d 69 -e 1 --serveropt sgd --lr 1.25 --wdecay 0 --momentum 0.9"
server_sgdmlr1p5_args="-d 69 -e 1 --serveropt sgd --lr 1.5 --wdecay 0 --momentum 0.9"
...
do
    ...
    for server_opt_args in server_sgdmlr0p5_args server_sgdmlr0p75_args server_sgdmlr1p0_args server_sgdmlr1p25_args server_sgdmlr1p5_args
    do
        # parse server optimizer name
        server_opt=$(echo ${server_opt_args} | awk -F "_" '{print $2}')

        experiment_name=lrgridsearchB${trial_count}_${client_opt}_${server_opt}
